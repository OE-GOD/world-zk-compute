//! Anomaly Detection Guest Program (SP1 version)
//!
//! This runs inside the SP1 zkVM and produces a proof that:
...
fn main() {
    ...
    let input = sp1_zkvm::io::read::<DetectionInput>();
